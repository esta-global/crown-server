...
module.exports.create = async (req, res) => {
  ...
  try {
    ...
    logFile.write(
      `Controller: documentFormatController: create, Error : ${error}`
    );
...
module.exports.findById = async (req, res) => {
  ...
  try {
    ...
    logFile.write(
      `Controller: documentFormatController: findById, Error : ${error}`
    );
    response.message = error.message;
  }
  res.status(response.status).send(response);
...
module.exports.findAll = async (req, res) => {
  ...
  try {
    ...
    logFile.write(
      `Controller: documentFormatController: findAll, Error : ${error}`
    );
    response.message = error.message;
  }
  res.status(response.status).send(response);
...
module.exports.update = async (req, res) => {
  ...
  try {
    ...
    logFile.write(
      `Controller: documentFormatController: update, Error : ${error}`
    );
    response.message = error.message;
  }
  res.status(response.status).send(response);
...
module.exports.delete = async (req, res) => {
  const response = _.cloneDeep(defaultServerResponse);
  try {
    const serviceResponse = await documentFormatService.delete(req.params);
    if (serviceResponse.isOkay) {
      response.body = serviceResponse.body;
      response.status = 200;
    } else {
    ...
    logFile.write(
      `Controller: documentFormatController: delete, Error : ${error}`
    );
    response.message = error.message;
  }
  res.status(response.status).send(response);
...
module.exports.deleteMultiple = async (req, res) => {
  ...
  try {
    ...
    logFile.write(
      `Controller: documentFormatController: deleteMultiple, Error : ${error}`
    );
    response.message = error.message;
  }
  res.status(response.status).send(response);
